function initDatabaseModule(app) {
    ...
    app.database = {
        ...
        startAutoRefresh() {
            ...
            console.log('โ… Database auto-refresh started (click-triggered, 5s interval)');
        },
        ...
        stopAutoRefresh() {
            if (this.autoRefreshInterval) {
                clearInterval(this.autoRefreshInterval);
                this.autoRefreshInterval = null;
                console.log('๐‘ Database auto-refresh stopped');
            }
        },
        ...
        async loadSessions(silent = false) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (!silent) {
                        console.log(`โ… Loaded ${this.sessions.length} sessions`);
                    }
                } else {
                    throw new Error(data.message || 'Failed to load sessions');
                }
            } catch (error) {
                console.error('โ Error loading sessions:', error);
                if (!silent) {
                    this.error = 'เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เนเธซเธฅเธ”เธเนเธญเธกเธนเธฅ Session เนเธ”เน: ' + error.message;
                    app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เนเธซเธฅเธ”เธเนเธญเธกเธนเธฅ Session', 'error');
                }
            } finally {
                if (!silent) {
                    this.loading = false;
        ...
        async loadMessages(sessionId) {
            if (!sessionId) {
                console.error('โ Invalid session ID');
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    ...
                    this.renderMessages();
                    console.log(`โ… Loaded ${this.messages.length} messages for session ${sessionId}`);
                } else {
                    throw new Error(data.message || 'Failed to load messages');
                }
            } catch (error) {
                console.error('โ Error loading messages:', error);
                this.error = 'เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เนเธซเธฅเธ”เธเนเธญเธเธงเธฒเธกเนเธ”เน: ' + error.message;
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เนเธซเธฅเธ”เธเนเธญเธเธงเธฒเธก', 'error');
            } finally {
                this.loading = false;
            }
        },
        ...
        async updateSession(sessionId, updates) {
            if (!sessionId || !updates) {
                console.error('โ Invalid parameters for updateSession');
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    app.showToast('เธญเธฑเธเน€เธ”เธ— Session เธชเธณเน€เธฃเนเธ', 'success');
                ...
                console.error('โ Error updating session:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธญเธฑเธเน€เธ”เธ— Session: ' + error.message, 'error');
            }
        },
        ...
        async deleteSession(sessionId) {
            ...
            if (!confirm('เนเธเนเนเธเธซเธฃเธทเธญเนเธกเนเธ—เธตเนเธเธฐเธฅเธ Session เธเธตเน? เธเนเธญเธเธงเธฒเธกเธ—เธฑเนเธเธซเธกเธ”เธเธฐเธ–เธนเธเธฅเธเธ”เนเธงเธข')) {
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    app.showToast('เธฅเธ Session เธชเธณเน€เธฃเนเธ', 'success');
                ...
                console.error('โ Error deleting session:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธฅเธ Session: ' + error.message, 'error');
            }
        },
        ...
        async updateMessage(messageId, content) {
            if (!messageId || !content) {
                console.error('โ Invalid parameters for updateMessage');
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    app.showToast('เธญเธฑเธเน€เธ”เธ—เธเนเธญเธเธงเธฒเธกเธชเธณเน€เธฃเนเธ', 'success');
                ...
                console.error('โ Error updating message:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธญเธฑเธเน€เธ”เธ—เธเนเธญเธเธงเธฒเธก: ' + error.message, 'error');
            }
        },
        ...
        async deleteMessage(messageId) {
            if (!messageId) {
                console.error('โ Invalid message ID');
                return;
            }
            
            if (!confirm('เนเธเนเนเธเธซเธฃเธทเธญเนเธกเนเธ—เธตเนเธเธฐเธฅเธเธเนเธญเธเธงเธฒเธกเธเธตเน?')) {
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    app.showToast('เธฅเธเธเนเธญเธเธงเธฒเธกเธชเธณเน€เธฃเนเธ', 'success');
                    await this.loadMessages(this.selectedSession.session_id);
                } else {
                    throw new Error(data.message || 'Failed to delete message');
                }
            } catch (error) {
                console.error('โ Error deleting message:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธฅเธเธเนเธญเธเธงเธฒเธก: ' + error.message, 'error');
            }
        },
        ...
        async bulkDeleteSessions() {
            if (this.bulkSelection.size === 0) {
                app.showToast('เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธ Session เธ—เธตเนเธ•เนเธญเธเธเธฒเธฃเธฅเธ', 'warning');
                return;
            }
            
            if (!confirm(`เนเธเนเนเธเธซเธฃเธทเธญเนเธกเนเธ—เธตเนเธเธฐเธฅเธ ${this.bulkSelection.size} Sessions?`)) {
                return;
            }
            ...
            for (const sessionId of this.bulkSelection) {
                try {
                    ...
                    errorCount++;
                    console.error(`โ Error deleting session ${sessionId}:`, error);
                }
            }
            
            this.bulkSelection.clear();
            app.showToast(`เธฅเธเธชเธณเน€เธฃเนเธ ${successCount} Sessions${errorCount > 0 ? `, เธฅเนเธกเน€เธซเธฅเธง ${errorCount} Sessions` : ''}`, 'success');
            await this.loadSessions();
        },
        ...
        async cleanupOldSessions(days) {
            if (!days || days < 1) {
                const input = prompt('เธเธฃเธธเธ“เธฒเธฃเธฐเธเธธเธเธณเธเธงเธเธงเธฑเธเธ—เธตเนเธ•เนเธญเธเธเธฒเธฃเธฅเนเธฒเธ (เน€เธเนเธ 7, 30, 90):', '7');
                if (!input) return;
                days = parseInt(input);
            }
            
            if (!confirm(`เนเธเนเนเธเธซเธฃเธทเธญเนเธกเนเธ—เธตเนเธเธฐเธฅเธ Session เธ—เธตเนเนเธกเนเนเธ”เนเนเธเนเธเธฒเธเธกเธฒเธเธเธงเนเธฒ ${days} เธงเธฑเธ?`)) {
                return;
            }
            ...
            try {
                ...
                if (data.success) {
                    app.showToast(`เธฅเธ ${data.deleted_count} Sessions เธชเธณเน€เธฃเนเธ`, 'success');
                    await this.loadSessions();
                } else {
                    throw new Error(data.message || 'Failed to cleanup sessions');
                }
            } catch (error) {
                console.error('โ Error cleaning up sessions:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธ—เธณเธเธงเธฒเธกเธชเธฐเธญเธฒเธ”เนเธ”เน: ' + error.message, 'error');
            }
        },
        ...
        async exportDatabase() {
            try {
                ...
                app.showToast('Export เธชเธณเน€เธฃเนเธ', 'success');
            } catch (error) {
                console.error('โ Error exporting database:', error);
                app.showToast('เนเธกเนเธชเธฒเธกเธฒเธฃเธ– Export เนเธ”เน: ' + error.message, 'error');
            }
        },
        ...
        renderSessionsList() {
            ...
            if (!container) {
                console.warn('โ ๏ธ Sessions list container not found');
                return;
            }
                ...
                container.innerHTML = `
                    <div class="text-center py-12">
                        ...
                        <p class="text-sm font-medium" style="color: var(--text-tertiary);">
                            ${this.filters.search || this.filters.platform !== 'all' ? 'เนเธกเนเธเธ Session เธ—เธตเนเธ•เธฃเธเธเธฑเธเน€เธเธทเนเธญเธเนเธ' : 'เธขเธฑเธเนเธกเนเธกเธต Session'}
                        </p>
                    </div>
                `;
                lucide.createIcons();
                ...
                return `
                    <div class="session-item card-enterprise p-4 hover:shadow-lg transition-all cursor-pointer border-2 ${isSelected ? 'border-purple-500' : 'border-transparent'}"
                        ...
                        <div class="flex justify-between text-xs" style="color: var(--text-tertiary);">
                            <span>เธชเธฃเนเธฒเธ: ${this.formatDate(session.created_at)}</span>
                            <span>เนเธเนเธฅเนเธฒเธชเธธเธ”: ${this.formatDateTime(session.last_active)}</span>
                        </div>
                    </div>
                `;
            }).join('');
            ...
            container.innerHTML = `
                <div class="flex items-center justify-between">
                    <div class="text-sm" style="color: var(--text-secondary);">
                        เนเธชเธ”เธ ${start} - ${end} เธเธฒเธ ${filtered.length} เธฃเธฒเธขเธเธฒเธฃ
                    </div>
        ...
        renderMessages() {
            ...
            if (!container) {
                console.warn('โ ๏ธ Messages list container not found');
                return;
            }
            ...
            if (this.messages.length === 0) {
                container.innerHTML = `
                    <div class="text-center py-12">
                        ...
                        <p class="text-sm font-medium" style="color: var(--text-tertiary);">เธขเธฑเธเนเธกเนเธกเธตเธเนเธญเธเธงเธฒเธกเนเธเธเธฒเธฃเธชเธเธ—เธเธฒเธเธตเน</p>
                    </div>
                `;
                lucide.createIcons();
                return;
            ...
            container.innerHTML = this.messages.map(msg => `
                <div class="message-item card-enterprise p-4 mb-3" data-message-id="${msg.id}">
                    <div class="flex items-start justify-between mb-2">
                        ...
                        <div class="flex gap-2">
                            <button class="btn-edit-msg p-1 hover:bg-gray-100 rounded transition-colors" title="เนเธเนเนเธเธเนเธญเธเธงเธฒเธก">
                                <i data-lucide="edit" class="w-4 h-4"></i>
                            </button>
                            <button class="btn-delete-msg p-1 hover:bg-red-100 text-red-600 rounded transition-colors" title="เธฅเธเธเนเธญเธเธงเธฒเธก">
        ...
        startEditMessage(messageId) {
            ...
            if (!message) {
                console.error('โ Message not found:', messageId);
                return;
            }
            ...
            if (!contentDiv) {
                console.error('โ Content div not found for message:', messageId);
                return;
            }
            ...
            if (saveBtn) {
                saveBtn.addEventListener('click', () => {
                    ...
                    if (newContent) {
                        ...
                        app.showToast('เธเนเธญเธเธงเธฒเธกเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธงเนเธเธงเนเธฒเธเนเธ”เน', 'warning');
                    }
                });
            }
        ...
        render() {
            ...
            if (!container) {
                console.error('โ Database container not found');
                return;
            }
                ...
                <div class="h-full flex flex-col animate-in">
                    ...
                    <div class="card-enterprise p-4 rounded-2xl shadow-lg mb-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
                            <input type="text" 
                                   id="filter-search"
                                   placeholder="๐” เธเนเธเธซเธฒ Session..." 
                            ...
                            <select id="filter-platform" class="px-3 py-2 border-2 rounded-lg font-bold transition-all focus:ring-2 focus:ring-purple-500"
                                    style="border-color: var(--border-primary); background-color: var(--bg-secondary); color: var(--text-primary);">
                                <option value="all">เธ—เธธเธ Platform</option>
                            ...
                            <select id="filter-bot-status" class="px-3 py-2 border-2 rounded-lg font-bold transition-all focus:ring-2 focus:ring-purple-500"
                                    style="border-color: var(--border-primary); background-color: var(--bg-secondary); color: var(--text-primary);">
                                <option value="all">เธ—เธธเธเธชเธ–เธฒเธเธฐ Bot</option>
                                <option value="enabled">Bot เน€เธเธดเธ”</option>
                                <option value="disabled">Bot เธเธดเธ”</option>
                            </select>
                            
                            <select id="filter-sort-by" class="px-3 py-2 border-2 rounded-lg font-bold transition-all focus:ring-2 focus:ring-purple-500"
                                    style="border-color: var(--border-primary); background-color: var(--bg-secondary); color: var(--text-primary);">
                                <option value="last_active">เน€เธฃเธตเธขเธ: เนเธเนเธฅเนเธฒเธชเธธเธ”</option>
                                <option value="created_at">เน€เธฃเธตเธขเธ: เธชเธฃเนเธฒเธ</option>
                                <option value="user_name">เน€เธฃเธตเธขเธ: เธเธทเนเธญ</option>
                            </select>
                            ...
                            <select id="filter-sort-order" class="px-3 py-2 border-2 rounded-lg font-bold transition-all focus:ring-2 focus:ring-purple-500"
                                    style="border-color: var(--border-primary); background-color: var(--bg-secondary); color: var(--text-primary);">
                                <option value="desc">โ“ เธกเธฒเธ โ’ เธเนเธญเธข</option>
                                <option value="asc">โ‘ เธเนเธญเธข โ’ เธกเธฒเธ</option>
                            </select>
                        </div>
                        ...
                        <div class="mt-3 pt-3 border-t flex items-center justify-between gap-3" style="border-color: var(--border-secondary);">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-bold" style="color: var(--text-tertiary);">
                                    เน€เธฅเธทเธญเธเนเธฅเนเธง <span class="bulk-count text-purple-600">0</span> เธฃเธฒเธขเธเธฒเธฃ
                                </span>
                            </div>
                    ...
                    <div class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4 overflow-hidden">
                        ...
                        <div class="flex flex-col">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <button class="btn-refresh-sessions p-2 rounded-lg transition-all hover:bg-gray-100" title="เธฃเธตเน€เธเธฃเธ">
                        ...
                        <div class="flex flex-col" id="messages-section">
                            <div class="flex-1 flex items-center justify-center">
                                <div class="text-center">
                                    ...
                                    <p class="font-semibold" style="color: var(--text-tertiary);">เน€เธฅเธทเธญเธ Session เน€เธเธทเนเธญเธ”เธนเธเนเธญเธเธงเธฒเธก</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm" style="color: var(--text-tertiary);">
                                ${this.escapeHtml(this.selectedSession.user_name)} โ€ข ${this.messages.length} เธเนเธญเธเธงเธฒเธก
                            </p>
                        </div>
                        <div class="flex gap-2">
                            <button class="btn-toggle-bot px-3 py-1 text-sm rounded-lg font-bold transition-all shadow-lg ${this.selectedSession.bot_enabled ? 'bg-red-100 text-red-700 hover:bg-red-200' : 'bg-green-100 text-green-700 hover:bg-green-200'}"
                                ...
                                ${this.selectedSession.bot_enabled ? 'โ” เธเธดเธ” Bot' : '๐ค– เน€เธเธดเธ” Bot'}
                            </button>
...
if (typeof window !== 'undefined') {
    document.addEventListener('alpine:initialized', () => {
        console.log('๐ข Database module ready for initialization');
        const appElement = document.querySelector('[x-data]');
        if (appElement && appElement.__x && appElement.__x.$data) {
            const app = appElement.__x.$data;
            if (!app.database) {
                console.log('๐”ต Auto-initializing database module');
