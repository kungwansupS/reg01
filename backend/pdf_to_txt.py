...
from app.config import PDF_INPUT_FOLDER, PDF_QUICK_USE_FOLDER, debug_list_files, GEMINI_MODEL_NAME, LLM_PROVIDER # เพิ่ม GEMINI_MODEL_NAME
...
# เรียก get_llm_model() ครั้งเดียว (จะได้ Client ถ้าเป็น Gemini)
...
def organize_with_llm(raw_text, filename):
    ...
    try:
        ...
        if LLM_PROVIDER == "gemini":
            # อัปเดต: เรียกผ่าน client.models.generate_content
            ...
            # Fallback for OpenAI or others if implemented
            return ""
